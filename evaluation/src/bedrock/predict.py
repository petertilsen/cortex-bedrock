...
class BedrockPredict:
    def __init__(self, model="anthropic.claude-3-haiku-20240307-v1:0"):
        self.model = model
    ...
    def answer_question(self, idx, question):
        ...
        response = self.bedrock_client.invoke_model(
            modelId=os.getenv("MODEL", self.model),
        ...
        t2 = time.time()
        response_time = t2 - t1
        return content, search_memory_time, response_time, memories
...
if __name__ == "__main__":
    ...
    bedrock_predict = BedrockPredict()
    bedrock_predict.process_data_file("../../dataset/locomo10.json", args.output_file_path)
